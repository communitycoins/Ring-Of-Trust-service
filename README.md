...
- Use a single line pipe-delimited configuration file: buildchain.conf 
  - coin-name| 
  - rpc-user|
  - rpc-ww|
  - rpc-port|
  - block confirmations| (not used)
  - block data directory|
  - magic bytes| (4-bytes block separator)
  - version (base50 version byte; not used)